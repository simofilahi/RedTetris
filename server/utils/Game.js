...
var Game = /** @class */ (function (_super) {
    ...
    function Game() {
        ...
        _this.spectrumMap = _this.mapGenerator();
        _this.addShapeToMap();
    ...
    Game.prototype.landSpectrum = function () {
        for (var mapRow = 0; mapRow < this.map.length; mapRow++) {
            for (var mapCol = 0; mapCol < this.map[mapRow].length; mapCol++) {
                if (this.map[mapRow][mapCol].value !== "." &&
        ...
        this.spectrumMap.forEach(function (row) {
            row.forEach(function (item) {
    ...
    Game.prototype.gameOverStatus = function () {
        if (this.gameOver)
            return true;
    };
    Game.prototype.getlandSpectrum = function () {
